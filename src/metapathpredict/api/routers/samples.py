...
async def list_samples(
    ...
    class_filter: ClassLabel | None = Query(None, description="Filter by class"),
    source_filter: str | None = Query(None, description="Filter by source (e.g., 'NCBI')"),
    search: str | None = Query(None, description="Search by name or NCBI ID"),
    min_length: int | None = Query(None, ge=0, description="Minimum sequence length"),
    max_length: int | None = Query(None, description="Maximum sequence length"),
...
async def get_sample_sequence(
    ...
    end: int | None = Query(None, description="End position (exclusive)"),
):
    """
